		...
		<main class="ttr-wrapper" style="background-color: #F3F3F3;">
			...
			<div class="db-breadcrumb">
					...
					<ul class="db-breadcrumb-list">
						<li><i class="fa fa-home"></i>Active Employees</li>
					</ul>
				</div> 
					...
					<div class="col-lg-12 m-b30">
								<div class="table-responsive">
									<table id="table" class="table hover" style="width:100%; margin-top: 20px;">
										<thead>
											<tr>
												<th width="150"><center>ACTIONS</center></th>
												<th> Employee ID</th>
												<th>FULLNAME</th>
												<th>EMAIL</th>
												<th>POSITION</th>
													...
													<div class="modal-dialog modal-lg">
														<div class="modal-content">
															<div class="modal-header">
																<h4 class="modal-title"><img src="../assets/images/1.png" style="width: 30px; height: 30px;">&nbsp;Employee Details</h4>
															...
															<div class="modal-body">
																...
																<div class="row">
                                                                    ...
                                                                    <label class="col-form-label">Employee No.</label>
																		<input class="form-control" type="text" name="new_emp" value="202300012" readonly style="background-color: white;" >

																		<label class="col-form-label">Full Name</label>
																		<input class="form-control" type="text" name="new_name" value="Sean Singco" readonly style="background-color: white;" >

																		<label class="col-form-label">Email Address</label>
																		<input class="form-control" type="text" name="new_email" value="SeanBrad@gmail.com" readonly style="background-color: white;" >
																		
																		<label class="col-form-label">Permanent Address</label>
																		<input class="form-control" type="text" name="new_address" value="no. 25 gitnang bayan 1, San mateo rizal" readonly style="background-color: white;" >

																		<label class="col-form-label">Passsword</label>
																		<input class="form-control" type="text" name="new_password" value="12345" readonly >

																		<label class="col-form-label">Mobile Number</label>
																		<input class="form-control" type="text" name="new_number" value="09323195558" min="1" max="999" readonly style="background-color: white;" >


																		<label class="col-form-label">Gender</label>
																		<input class="form-control" type="text" name="new_gender" value="Male" readonly>

																		<label class="col-form-label">Position</label>
																		<select class="form-control" name="new_position"  id="new_position" required style="color: black!important;" readonly>
																		...
																		<input class="form-control" type="number" name="new_age" value="25" readonly
                                                                        
																		<label class="col-form-label">Place of Birth</label>
																		<input class="form-control" type="text" name="new_birth" value="San Mateo Rizal" readonly>
                                                                        
																		<label class="col-form-label">Date Started</label>
																		<input class="form-control" type="text" name="new_started" value="June 23, 2012" readonly>
																	</div>
																</div>
															</div>
