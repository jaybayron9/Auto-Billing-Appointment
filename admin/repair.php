...
<html lang="en">
	...
	<body class="ttr-opened-sidebar ttr-pinned-sidebar"  style="background-color: #1C4E80!important;">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
            ...
            <div class="icon-box" style="width: 100%;">
                <div class="icon"><i class="fas fa-person-chalkboard"></i></div>
                    <h4><a  href="timing.php" >Timing belt replacement</a></h4>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
                <div class="icon-box" style=" width: 100%;">
                    ...
                    <h4><a href="engine.php">Engine Repair</a></h4>
                </div>
            </div>
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0">
            <div class="icon-box" style="width: 100%;">
              ...
              <h4><a href="wheel.php">Wheel Alignment</a></h4>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0">
            <div class="icon-box" style=" width: 100%;">
              <div class="icon"><i class="fas fa-hammer"></i></div>
              <h4><a href="oxygen.php">Oxygen Sensor Replacement</a></h4>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch mt-4">
            <div class="icon-box" style="width: 100%;">
              ...
              <h4><a href="brake.php">Brake Work</a></h4>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch mt-4">
            <div class="icon-box" style="width: 100%;">
              ...
              <h4><a href="trans.php">Transmission Overhaul</a></h4>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch mt-4">
            <div class="icon-box" style="width: 100%;">
              <div class="icon"><i class="fas fa-wrench"></i></div>
              <h4><a href="clutch.php">Clutch Lining Replacement</a></h4>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch mt-4">
            <div class="icon-box" style="width: 100%;">
              <div class="icon"><i class="fas fa-wrench"></i></div>
              <h4><a href="radiator.php">Radiator Replacement</a></h4>
            </div>
          </div>
