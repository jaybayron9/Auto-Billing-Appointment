...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="../dashboard/assets/css/dash.css">
	</head>
	<style type="text/css">
	...
	<body class="ttr-opened-sidebar ttr-pinned-sidebar"  style="background-color: #F3F3F3!important;">
		...
		<div class="ttr-sidebar"  style="background-color: #ff5722;">
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-6 col-lg-3 col-xl-3 col-sm-6 col-6">
						<div class="widget-card widget-bg3 btn blue" style=" padding: 40px 60px;">		
							<div class="icon">
								<!-- <i class="ti-timer"></i> -->
							</div>				 
							<div class="wc-item">
					...
					<div class="col-md-6 col-lg-3 col-xl-3 col-sm-6 col-6">
						<div class="widget-card widget-bg2 btn yellow" style=" padding: 40px 50px;">
							<div class="icon">
								<!-- <i class="ti-user"></i> -->
							</div>				 
							<div class="wc-item">
				...
				<div id="add" class="modal fade" role="dialog">
															...
															<div class="modal-body">
																<div class="row">
                                                                    ...
                                                                    <label class="col-form-label">Brand</label>
																		...
																		<input class="form-control" type="text" name="repair" >
																		...
																		<label class="col-form-label">Type of Car</label>
								...
								<?php
									...
									if (isset($_POST['add_app'])) {
										...
										$sql=mysqli_query($conn,"insert into appointment(client_id, brand, model, pms, schedule, repair, time, color, type) values('$client','$brand','$model','$pms','$schedule','$repair','$time','$color','$type')");
										

										// $model->addAppointment($client, $brand, $model, $pms, $schedule, $repair, $time, $color, $type);
