...
<head>
  ...
  <header id="header" class="fixed-top" style="background-color: #1C4E80;">
    <div class="container d-flex align-items-center">
      <h1 class="logo me-auto"><a href="index.html">CJCE AUTOPARTS</a></h1>
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="index.php">PMS</a></li>
          <li><a class="nav-link scrollto" href="index.php">Repair</a></li>
