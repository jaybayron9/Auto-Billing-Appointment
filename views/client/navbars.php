<?php  Auth::checkAuth($_SESSION['client_auth'], $_SESSION['client_email_auth']); ?>
		...
		<div class="ttr-sidebar-logo" style=" border-top: 1px solid white; background-color: #1C4E80; border-bottom: solid 0px #cfd8dc; background-position: center;background-repeat: no-repeat;background-size: cover;height: 135px;">
			<div style="padding-left: 12px; padding-top: 12px;">
				...
				<div class="info-container">
					<div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="color: white; font-size: 15px;"><b><?= $_SESSION['client_email_auth'] ?></b></div>
				</div>
			</div>
		</div>
		<nav class="ttr-sidebar-navi" style="background-color: #1C4E80;">
			<ul>
				<li style="margin-top: 0px; background-color: #00BFFF;">
					<a href="?vs=?client" class="ttr-material-button">
						<span class="ttr-icon"><i class="ti-home"></i></span>
						<span style="color: black;" class="ttr-label">Home</span>
					</a>
				</li>
                <li class="" style="margin-top: 0px; background-color: #00BFFF;">
                    <a href="?vs=inbox" class="ttr-material-button">
                        <span class="ttr-label" style="color: black;"> Message</span>
                    </a>
                </li>
			</ul>
		</nav>
