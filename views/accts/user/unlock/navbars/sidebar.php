        ...
        <div class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
            <div class="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                <ul class="pb-2 space-y-2">
                    ...
                    <li>
                        <a href="?vs=status" class="<?= urlIs('vs=status') ? 'bg-sky-300' : '' ?> flex items-center p-2 text-base text-gray-900 hover:bg-gray-100 rounded-lg group font-semibold">
                    ...
                    <li>
                        <a href="?vs=history" class="<?= urlIs('vs=history') ? 'bg-sky-300' : '' ?> flex items-center p-2 text-base text-gray-900 hover:bg-gray-100 rounded-lg group font-semibold">
