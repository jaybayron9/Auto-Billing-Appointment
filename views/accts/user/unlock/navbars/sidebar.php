        ...
        <div class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
            <div class="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200">
                <ul class="pb-2 space-y-2">
                    <li>
                        <a href="?vs=_/" class="<?= urlIs('vs=_/') ? 'bg-gray-200' : '' ?> text-gray-700 flex items-center p-2 text-base hover:bg-gray-100 rounded-md group font-semibold text-sm"> 
                    ...
                    <li>
                        <a href="?vs=appointments" class="<?= urlIs('vs=appointments') ? 'bg-gray-200' : '' ?> flex items-center p-2 text-base text-gray-700 hover:bg-gray-100 rounded-md group font-semibold text-sm">
                    ...
                    <li>
                        <a href="?vs=status" class="<?= urlIs('vs=status') ? 'bg-gray-200' : '' ?> flex items-center p-2 text-base text-gray-700 hover:bg-gray-100 rounded-md group font-semibold text-sm">
                    ...
                    <li>
                        <a href="?vs=history" class="<?= urlIs('vs=history') ? 'bg-gray-200' : '' ?> flex items-center p-2 text-base text-gray-700 hover:bg-gray-100 rounded-md group font-semibold text-sm">
                    ...
                    <li>
                        <a href="?vs=mycar" class="<?= urlIs('vs=mycar') ? 'bg-gray-200' : '' ?> flex items-center p-2 text-base text-gray-700 hover:bg-gray-100 rounded-md group font-semibold text-sm">
