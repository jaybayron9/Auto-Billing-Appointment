                ...
                <table id="table" class="stripe hover" style="width:100%; padding-top: 1em;  padding-bottom: 1em;">
                    <thead>
                        <tr>
                            ...
                            <th data-priority="11" class="whitespace-nowrap text-xs uppercase text-center text-white">POSITION</th>
                            <th data-priority="2" data-orderable="false" class="whitespace-nowrap text-xs uppercase text-center">ACTION</th> 
                        </tr>
                    </thead>
                    <tbody id="tbody">
    ...
    var table = $('#table').DataTable({
        ...
        "drawCallback": () => {
            $('.edit-btn').click(function() {
                $('#coe-field').html('<object data="?support_rq=receipt" type="application/pdf" async defer class="w-full h-96">');
