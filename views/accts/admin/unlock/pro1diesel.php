    ...
    <div class="px-4 h-full my-[80px]">
        <div class="p-8 mt-6 lg:mt-0 rounded shadow bg-white">
            <div class="mb-5 flex gap-x-5">
                <div class="flex flex-row shadow-md p-2 border border-gray-200">
                    ...
                    <select name="" id="category" class="py-0 rounded">
                        ...
                        <option value="3">AC Services & Repair</option>
                        <option value="4">Tires & Wheels Care</option>
                    </select>
                </div>
                <div class="flex flex-row shadow-md p-2 border border-gray-200">
                    <label for="type" class="font-semibold font-mono">TYPE:</label>
                    <select id="type" class="py-0 rounded">
                        <option value="1" <?= urlIs('vs=_admin/pro1diesel') ? 'selected' : '' ?>>Diesel</option>
            ...
            <table id="table" class="stripe hover" style="width:100%; padding-top: 1em;  padding-bottom: 1em;">
                ...
                <tbody id="tbody">
                    <?php foreach ($conn::select('estimator', '*', ['service' => 1, 'car_type' => 2]) as $item) { ?>
