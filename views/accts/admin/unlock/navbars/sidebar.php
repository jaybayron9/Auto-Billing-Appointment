                ...
                <ul class="pb-2 space-y-2">
                    ...
                    <li>
                        <a href="?vs=_admin/transact" class="<?= urlIs('vs=_admin/transact') ? 'bg-gray-100 shadow border border-gray-300' : '' ?> flex items-center p-2 text-gray-700 hover:bg-gray-100 rounded-md group font-semibold text-sm">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 <?= urlIs('vs=_admin/transact') ? 'text-gray-900' : 'text-gray-500' ?> group-hover:text-gray-900" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <li>
                        <?php 
                        $product = urlIs('vs=_admin/pro1diesel') || urlIs('vs=_admin/pro1gas') || urlIs('vs=_admin/pro2') || urlIs('vs=_admin/pro3') || urlIs('vs=_admin/pro4');
                        ?>
