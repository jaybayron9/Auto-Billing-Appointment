                ...
                <ul class="pb-2 space-y-2">
                    ...
                    <li>
                        ...
                        <ul id="dropdown-example" class="hidden py-2 space-y-2">
                            <li>
                                <a href="?vs=_admin/pendings" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Pendings</a>
                            </li>
                            <li>
                    ...
                    <li>
                        <a href="?vs=_admin/inbox" class="<?= urlIs('vs=_admin/inbox') ? 'bg-sky-300' : '' ?> flex items-center p-2 text-base text-gray-900 hover:bg-gray-100 rounded-lg group font-semibold">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
