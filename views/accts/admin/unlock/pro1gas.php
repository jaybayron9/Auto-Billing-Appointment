        ...
        <div class="p-8 mt-6 lg:mt-0 rounded shadow bg-white">
            <div class="mb-5 flex gap-x-5">
                ...
                <div class="flex flex-row shadow-md p-2 border border-gray-200">
                    ...
                    <select name="" id="type" class="py-0 rounded">
                        <option value="1">Diesel</option>
                        <option value="2" <?= urlIs('vs=_admin/pro1gas') ? 'selected' : '' ?>>Gas</option>
                    </select>
                </div>
                <div class="ml-auto">
                    <div class="p-1">
            ...
            <table id="table" class="stripe hover" style="width:100%; padding-top: 1em;  padding-bottom: 1em;">
                ...
                <tbody id="tbody">
                    <?php foreach ($conn::select('estimator', '*', ['service' => 1, 'car_type' => 1]) as $item) { ?>
