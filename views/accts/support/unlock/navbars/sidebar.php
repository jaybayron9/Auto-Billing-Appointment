        ...
        <div class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
            <div class="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                <ul class="pb-2 space-y-2">
                    <li>
                        <a href="?vs=_sup/" class="<?= urlIs('vs=_sup/') ? 'bg-gray-100 shadow border border-gray-300' : '' ?> flex items-center p-4 text-gray-700 hover:bg-gray-100 rounded-md group font-semibold text-sm">
                    ...
                    <li>
                        <a href="?vs=_sup/job_order" class="<?= urlIs('vs=_sup/job_order') ? 'bg-gray-100 shadow border border-gray-300' : '' ?> flex items-center p-4 text-gray-700 hover:bg-gray-100 rounded-md group font-semibold text-sm">
                    ...
                    <li>
                        <a href="?vs=_sup/serv_his" class="<?= urlIs('vs=_sup/serv_his') ? 'bg-gray-100 shadow border border-gray-300' : '' ?> flex items-center p-4 text-gray-700 hover:bg-gray-100 rounded-md group font-semibold text-sm">
                    ...
                    <li>
                        <a href="?vs=_sup/service" class="<?= urlIs('vs=_sup/service') ? 'bg-gray-100 shadow border border-gray-300' : '' ?> flex items-center p-4 text-gray-700 hover:bg-gray-100 rounded-md group font-semibold text-sm">
